...
import { apiFacturaAnular } from '../../api/facturaAnular.api'
...
interface OwnProps {
  ...
  factura: FacturaBoaProps | null
}

type Props = OwnProps

/**
 * @description Cuadro de dialogo para anular documentos
 * @param props
 * @constructor
 */
  ...
  const handleOk = async () => {
    ...
    if (aux) {
      Swal.fire({
        ...
        preConfirm: () => {
          setLoading(true)
          return apiFacturaAnular([factura?.cuf!], value.codigoMotivo)
        },
