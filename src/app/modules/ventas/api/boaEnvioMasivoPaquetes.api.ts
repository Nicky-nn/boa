...
const query = gql`
  mutation BOA_ENVIO_MASIVO($input: BoaPeriodoInput) {
    facturaBoletoAereoEnvioMasivo(input: $input) {
      codigoPuntoVenta
      codigoSucursal
      createdAt
      estado
...
export const apiBoaEnvioMasivoPaquetes = async (
  ...
  try {
    ...
    return data.facturaBoletoAereoEnvioMasivo
  } catch (e: any) {
